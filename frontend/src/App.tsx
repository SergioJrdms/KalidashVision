...
import ReplayPrecisao from "./pages/ReplayPrecisao";
...
function AppShell() {
  ...
  if (route.screen === "processos") content = <Processos go={goTyped} />;
    ...
    else if (route.tab === "duvidas") content = <Duvidas proc={proc} go={goTyped} />;
    ...
    else if (route.tab === "replay-precisao") content = <ReplayPrecisao proc={proc} go={goTyped} />;
