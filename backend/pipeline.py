...
def agregar_portfolio(sb: Client, empresa: str) -> dict[str, dict]:
    ...
    # Contagem de padrões com confiança alta (entra na fórmula de maturidade)
    ...
    try:
        ...
        pass  # tabela pode não existir em ambientes antigos

    # Finaliza: top comportamentos + composição de valor + percentuais + MATURIDADE
    saida: dict[str, dict] = {}
