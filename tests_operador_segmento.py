...
i_cam2 = fonte.index("descritores_track = list(descritores_track) + fechar_descritores(", i_proc)
i_shadow = fonte.index("_registrar_operador_segmento_sombra(descritores_track", i_proc)
